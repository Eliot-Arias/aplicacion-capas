namespace AplicacionCapas
{
    partial class Principal
    {
        ...
        private void InitializeComponent()
        {
            ...
            menuRoles = new ToolStripMenuItem();
            ...
            // ConfigMenu
            // 
            ConfigMenu.DropDownItems.AddRange(new ToolStripItem[] { menuUsuario, menuRoles });
            ConfigMenu.Name = "ConfigMenu";
            ConfigMenu.Size = new Size(100, 20);
            ConfigMenu.Text = "Administracion";
            // 
            // menuUsuario
            // 
